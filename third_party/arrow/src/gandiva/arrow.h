...
#include "third_party/arrow/src/arrow/array.h"         // IWYU pragma: export
#include "third_party/arrow/src/arrow/builder.h"       // IWYU pragma: export
#include "third_party/arrow/src/arrow/pretty_print.h"  // IWYU pragma: export
#include "third_party/arrow/src/arrow/record_batch.h"  // IWYU pragma: export
#include "third_party/arrow/src/arrow/status.h"        // IWYU pragma: export
#include "third_party/arrow/src/arrow/type.h"          // IWYU pragma: export
