...
#include "third_party/arrow/src/arrow/flight/platform.h"  // IWYU pragma: keep

// This header holds the Flight protobuf definitions.

// Need to include this first to get our gRPC customizations
#include "third_party/arrow/src/arrow/flight/customize_protobuf.h"  // IWYU pragma: export
