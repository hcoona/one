...
#include "third_party/arrow/src/arrow/config.h"

// Include various "api.h" entrypoints and check they don't leak internal symbols

#include "third_party/arrow/src/arrow/api.h"      // IWYU pragma: keep
#include "third_party/arrow/src/arrow/io/api.h"   // IWYU pragma: keep
#include "third_party/arrow/src/arrow/ipc/api.h"  // IWYU pragma: keep

#ifdef ARROW_COMPUTE
#include "third_party/arrow/src/arrow/compute/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_CSV
#include "third_party/arrow/src/arrow/csv/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_DATASET
#include "third_party/arrow/src/arrow/dataset/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_FILESYSTEM
#include "third_party/arrow/src/arrow/filesystem/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_FLIGHT
#include "third_party/arrow/src/arrow/flight/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_JSON
#include "third_party/arrow/src/arrow/json/api.h"  // IWYU pragma: keep
#endif

#ifdef ARROW_PYTHON
#include "third_party/arrow/src/arrow/python/api.h"  // IWYU pragma: keep
#endif
