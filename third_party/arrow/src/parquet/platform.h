...
#include "third_party/arrow/src/arrow/buffer.h"         // IWYU pragma: export
#include "third_party/arrow/src/arrow/io/interfaces.h"  // IWYU pragma: export
#include "third_party/arrow/src/arrow/status.h"         // IWYU pragma: export
#include "third_party/arrow/src/arrow/type_fwd.h"       // IWYU pragma: export
#include "third_party/arrow/src/arrow/util/macros.h"    // IWYU pragma: export
