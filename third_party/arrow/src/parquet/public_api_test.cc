...
#include "third_party/arrow/src/parquet/api/io.h"      // IWYU pragma: keep
#include "third_party/arrow/src/parquet/api/reader.h"  // IWYU pragma: keep
#include "third_party/arrow/src/parquet/api/schema.h"  // IWYU pragma: keep
#include "third_party/arrow/src/parquet/api/writer.h"  // IWYU pragma: keep
