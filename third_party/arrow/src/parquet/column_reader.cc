...
#include "third_party/arrow/src/parquet/encryption/internal_file_decryptor.h"
#include "third_party/arrow/src/parquet/level_comparison.h"
...
#include "third_party/arrow/src/parquet/thrift_internal.h"  // IWYU pragma: keep
// Required after "arrow/util/int_util_internal.h" (for OPTIONAL)
#include "third_party/arrow/src/parquet/windows_compatibility.h"
