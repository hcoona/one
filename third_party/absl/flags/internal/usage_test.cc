...
#include "third_party/absl/flags/internal/path_util.h"
...
TEST_F(UsageReportingTest, TestFlagsHelpHRF) {
  ...
  Flags from third_party/absl/flags/internal/usage_test.cc:
...
path.
  ...
  EXPECT_TRUE(absl::StrContains(
      test_out_str, "Flags from third_party/absl/flags/internal/usage_test.cc:"));
  EXPECT_TRUE(
