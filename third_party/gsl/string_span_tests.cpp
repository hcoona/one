...
#include "third_party/gsl/gsl_assert"  // for Expects, fail_fast (ptr only)
#include "third_party/gsl/pointers"    // for owner
#include "third_party/gsl/span"        // for span, dynamic_extent
#include "third_party/gsl/string_span" // for basic_string_span, operator==, ensure_z
