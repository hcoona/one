...
#include <QThread>
  ...
  #include "third_party/thrift/src/thrift/async/TAsyncProcessor.h"
  #include "third_party/thrift/src/thrift/qt/TQTcpServer.h"
  #include "third_party/thrift/src/thrift/qt/TQIODeviceTransport.h"
