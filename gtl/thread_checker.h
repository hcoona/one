...
// but not thread-affinity. Prefer gtl::SequenceChecker to verify thread-safe
// access.
//
...
//
//     void MyOtherMethod()
//         GTL_VALID_CONTEXT_REQUIRED(thread_checker_) {
//       foo_ = 42;
//     }
//
//    private:
//     int foo_ GTL_GUARDED_BY_CONTEXT(thread_checker_);
//
