...
#ifndef GTL_NUMERIC_CHECKED_MATH_H_
#define GTL_NUMERIC_CHECKED_MATH_H_
...
#include "gtl/numeric/checked_math_impl.h"
...
class CheckedNumeric {
 ...
 public:
  ...
  AssignIfValid(Dst* result) const {
    return GTL_NUMERIC_LIKELY(IsValid<Dst>())
...
#endif  // GTL_NUMERIC_CHECKED_MATH_H_
