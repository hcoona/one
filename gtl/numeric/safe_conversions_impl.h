...
#ifndef GTL_NUMERIC_SAFE_CONVERSIONS_IMPL_H_
#define GTL_NUMERIC_SAFE_CONVERSIONS_IMPL_H_
...
#define GTL_NUMERIC_LIKELY(x) __builtin_expect(!!(x), 1)
#define GTL_NUMERIC_UNLIKELY(x) __builtin_expect(!!(x), 0)
#else
#define GTL_NUMERIC_LIKELY(x) (x)
#define GTL_NUMERIC_UNLIKELY(x) (x)
#endif
...
// larger.
template <typename Dst, typename Src>
struct StaticDstRangeRelationToSrcRange<Dst, Src, INTEGER_REPRESENTATION_SIGNED,
                                        INTEGER_REPRESENTATION_UNSIGNED> {
  static const NumericRangeRepresentation value =
      MaxExponent<Dst>::value > MaxExponent<Src>::value
          ? NUMERIC_RANGE_CONTAINED
...
template <typename Dst, typename Src>
struct StaticDstRangeRelationToSrcRange<
    Dst, Src, INTEGER_REPRESENTATION_UNSIGNED, INTEGER_REPRESENTATION_SIGNED> {
...
constexpr typename std::make_signed<
    typename gtl::internal::UnderlyingType<Src>::type>::type
...
#endif  // GTL_NUMERIC_SAFE_CONVERSIONS_IMPL_H_
