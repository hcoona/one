...
#ifndef GTL_NUMERIC_SAFE_CONVERSIONS_H_
#define GTL_NUMERIC_SAFE_CONVERSIONS_H_
...
#include "gtl/numeric/safe_conversions_impl.h"

#if !defined(__native_client__) && (defined(__ARMEL__) || defined(__arch64__))
#include "gtl/numeric/safe_conversions_arm_impl.h"
#define GTL_HAS_OPTIMIZED_SAFE_CONVERSIONS (1)
#else
#define GTL_HAS_OPTIMIZED_SAFE_CONVERSIONS (0)
#endif
...
#endif  // GTL_HAS_OPTIMIZED_SAFE_CONVERSIONS
#undef GTL_HAS_OPTIMIZED_SAFE_CONVERSIONS
...
constexpr Dst checked_cast(Src value) {
  ...
  using SrcType = typename internal::UnderlyingType<Src>::type;
  return GTL_NUMERIC_LIKELY((IsValueInRangeForNumericType<Dst>(value)))
...
#endif  // GTL_NUMERIC_SAFE_CONVERSIONS_H_
