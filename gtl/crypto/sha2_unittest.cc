...
TEST(Sha256Test, Test1) {
  ...
  gtl::crypto::SHA256HashString(input1, output_truncated1,
...
TEST(Sha256Test, Test2) {
  ...
  gtl::crypto::SHA256HashString(input2, output_truncated2,
...
TEST(Sha256Test, Test3) {
  ...
  gtl::crypto::SHA256HashString(input3, output_truncated3,
