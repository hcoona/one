...
// Implementation detail of gtl::void_t below.
template <typename...>
struct make_void {
  using type = void;
};
...
// gtl::void_t is an implementation of std::void_t from C++17.
//
// We use |gtl::internal::make_void| as a helper struct to avoid a C++14
// defect:
//   http://en.cppreference.com/w/cpp/types/void_t
//   http://open-std.org/JTC1/SC22/WG21/docs/cwg_defects.html#1558
template <typename... Ts>
using void_t = typename ::gtl::internal::make_void<Ts...>::type;
...
// gtl::in_place_type_t is an implementation of std::in_place_type_t from
// C++17. A tag type used for in-place construction when the type to construct
// needs to be specified, such as with gtl::unique_any, designed to be a
// drop-in replacement.
