...
#ifndef GTL_CONTAINER_CIRCULAR_DEQUE_H_
#define GTL_CONTAINER_CIRCULAR_DEQUE_H_
...
// gtl::circular_deque is similar to std::deque. Unlike std::deque, the
...
//
// If you want a similar container with only a queue API, use gtl::queue in
...
class circular_deque {
 ...
 public:
  ...
  typename std::enable_if<::gtl::internal::is_iterator<InputIterator>::value,
                          void>::type
  ...
  value_type& at(size_type i) {
    return const_cast<value_type&>(gtl::as_const(*this).at(i));
  }

  value_type& operator[](size_type i) {
    return const_cast<value_type&>(gtl::as_const(*this)[i]);
  }
...
// Implementations of gtl::Erase[If] (see base/stl_util.h).
...
#endif  // GTL_CONTAINER_CIRCULAR_DEQUE_H_
