...
#ifndef GTL_LOCATION_H_
#define GTL_LOCATION_H_
...
#define FROM_HERE ::gtl::Location::Current()
...
#define FROM_HERE ::gtl::Location::CreateFromHere(__func__, __FILE__, __LINE__)

#else

// TODO(http://crbug.com/760702) remove the __FILE__ argument from these calls.
#define FROM_HERE ::gtl::Location::CreateFromHere(__FILE__)
