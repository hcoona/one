...
# Generated from https://github.com/facebook/rocksdb/blob/v6.14.6/src.mk
LIB_SOURCES = [
    "cache/cache.cc",
...
# Generated opts & defines with help of Bear.
# Aligned new/delete buggy on GCC 4.9.2(Link error), remove it.
cc_library(
    name = "rocksdb",
    srcs = LIB_SOURCES + glob(["**/*.h"]),
    hdrs = glob(["include/**/*.h"]),
    copts = [
        "-std=c++11",
        "-fno-builtin-memcmp",
...
cc_library(
    name = "build_version",
    srcs = ["util/build_version.cc"],
    hdrs = ["util/build_version.h"],
    includes = ["util"],
)
